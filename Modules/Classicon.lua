...
local function GetDefaultAuraList()
	local auraTable = {
		...
		[GetSpellInfo(188501)]  = 0,    -- Spectral Sight
		[GetSpellInfo(102351)]  = 0,    -- Cenarion Ward
		[GetSpellInfo(193359)]  = 0,    -- True Bearing
		-- Movement Reduction Auras (1)
		[GetSpellInfo(5116)]	= 1,	-- Concussive Shot
		[GetSpellInfo(120)]		= 1,	-- Cone of Cold
		[GetSpellInfo(13809)]	= 1,	-- Frost Clip
		[GetSpellInfo(356723)]  = 1,    -- Scorpid Venom Trap
		[GetSpellInfo(195645)]  = 1,    -- Wing
		[GetSpellInfo(193357)]  = 1,    -- Shark Buff
		-- Purgable Buffs (2)
...
--		[GetSpellInfo(31842)]	= 2,	-- Divine Favor
		...
		[GetSpellInfo(213610)]  = 2,    -- Holy Ward
	...
	--	[GetSpellInfo(108978)]	= 3,	-- Alter Time
		...
		[GetSpellInfo(335255)]  = 3,    -- Spell Reflection
		[GetSpellInfo(335253)]  = 3,    -- Spell Reflection
		[GetSpellInfo(122470)]	= 3,	-- Touch of Karma
		[GetSpellInfo(61336)]	= 3,	-- Survival Instincts
		[GetSpellInfo(198589)]  = 3,    -- Blur
		[GetSpellInfo(197721)]  = 3,    -- Flourish
		...
		[GetSpellInfo(324143)]  = 4,    -- Conquerors Banner
		[GetSpellInfo(121471)]  = 4,    -- Shadow Blades
		[GetSpellInfo(325202)]  = 4,    -- Dance of Chi-Ji
		[GetSpellInfo(197871)]  = 4,    -- Dark Archangel
		[GetSpellInfo(345569)]  = 4,    -- Flagellation
		[GetSpellInfo(193357)]  = 4,    -- Ruthless Precision
		[GetSpellInfo(152262)]  = 4,    -- Seraphim
		[GetSpellInfo(193359)]  = 4,    -- True Bearing
		-- Roots (5)
	...
	--	[GetSpellInfo(3045)]	= 6,	-- Rapid Fire
		...
		[GetSpellInfo(193530)]  = 6,    -- Aspect of the Wild
		[GetSpellInfo(327022)]  = 6,    -- Kindred Empowerment
		[GetSpellInfo(260402)]  = 6,    -- Double Tap
		...
		[GetSpellInfo(356727)]  = 8,    -- Spider Venom
		...
		[GetSpellInfo(199804)]		= 9,	-- Between The Eyes
		...
		[GetSpellInfo(117526)]  = 9,    -- Binding Shot
		["163505"]              = 9,    -- Rake
		[GetSpellInfo(332423)]  = 9,    -- Sparkling Driftglobe Core
		[GetSpellInfo(338836)]  = 9,    -- Agent of Chaos
		[GetSpellInfo(357021)]  = 9,    -- Consecutive Concussion
		...
		[GetSpellInfo(186265)]  = 11,   -- Aspect of the Turtle
		[GetSpellInfo(323095)]  = 11,   -- Ultimate Form
		[GetSpellInfo(353114)]  = 11,   -- Keeper of the Grove
		[GetSpellInfo(213602)]  = 11,   -- Greater Fade
		-- Drink (12)
		[GetSpellInfo(118358)]	= 12,	-- Drink
		[GetSpellInfo(210294)] = 12, -- DIVINE FAVOR
